Pod::Spec.new do |s|
  ...
  s.license          = { :type => 'Apache License, Version 2.0', :file => 'jinsang_public_sub_lib-' + s.version.to_s + '/LICENSE.md' }
  s.author           = { 'jinsang' => 'jinsang@nhnent.com' }
  s.source           = { :http => 'https://github.com/milkybboy/jinsang_public_sub_lib/archive/' + s.version.to_s + '.zip' }
