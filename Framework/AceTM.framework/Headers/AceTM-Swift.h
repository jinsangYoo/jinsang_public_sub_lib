...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
+ (void)appDidFinishLaunchingWithResponder:(UIResponder * _Nullable)responder SWIFT_AVAILABILITY(ios,introduced=1.0.0,message="appDidFinishLaunching 안에서 호출");
...
+ (void)pvWithResponder:(UIResponder * _Nullable)responder;
+ (void)pvWithPage:(NSString * _Nullable)page;
+ (void)pvWithParameters:(NSString * _Nullable)parameters SWIFT_AVAILABILITY(ios,introduced=1.1.1,message="로그 파라미터를 완성된채 전송만 할때 사용");
...
+ (void)pushWithData:(NSDictionary * _Nullable)data SWIFT_AVAILABILITY(ios,introduced=1.0.8,message="push 알림 수신했을 때 호출");
...
+ (void)pageErrWithResponder:(UIResponder * _Nullable)responder;
+ (void)pageErrWithPage:(NSString * _Nullable)page;
+ (void)hrefWithHref:(NSString * _Nullable)href;
+ (void)telWithPhoneNumber:(NSString * _Nullable)phoneNumber;
+ (void)customerClickWithClickName:(NSString * _Nullable)clickName;
+ (void)snsWithProductNumber:(NSString * _Nullable)productNumber sns:(NSString * _Nullable)sns;
...
+ (void)reviewWithProductNumber:(NSString * _Nullable)productNumber reviewContents:(NSString * _Nullable)reviewContents score:(NSInteger)score;
+ (void)innerSearchWithResponder:(UIResponder * _Nullable)responder keyword:(NSString * _Nullable)keyword;
+ (void)innerSearchWithPage:(NSString * _Nullable)page keyword:(NSString * _Nullable)keyword;
+ (void)sdkErrWithFunctionName:(NSString * _Nullable)functionName reason:(NSString * _Nullable)reason;
+ (void)sdkErrWithMsg:(NSString * _Nullable)msg;
+ (BOOL)uiWebViewWithWebView:(UIWebView * _Nullable)webView shouldStartLoadWith:(NSURLRequest * _Nullable)request navigationType:(enum UIWebViewNavigationType)navigationType;
...
+ (void)userContentController:(WKUserContentController * _Nullable)userContentController didReceive:(WKScriptMessage * _Nullable)message;
...
+ (void)appOpenUrlWithResponder:(UIResponder * _Nullable)responder url:(NSURL * _Nullable)url;
+ (void)viewDidLoadWithResponder:(UIResponder * _Nullable)responder autoPv:(BOOL)autoPv;
@end


@interface AceTM (SWIFT_EXTENSION(AceTM))
+ (void)loginWithResponder:(UIResponder * _Nullable)responder userId:(NSString * _Nonnull)userId userAge:(NSInteger)userAge userGender:(NSString * _Nonnull)userGender groupDictionary:(NSDictionary<NSString *, NSNumber *> * _Nullable)groupDictionary;
...
+ (void)loginWithPage:(NSString * _Nullable)page userId:(NSString * _Nonnull)userId userAge:(NSInteger)userAge userGender:(NSString * _Nonnull)userGender groupDictionary:(NSDictionary<NSString *, NSNumber *> * _Nullable)groupDictionary;
+ (void)loginWithPage:(NSString * _Nullable)page userId:(NSString * _Nonnull)userId userAge:(NSInteger)userAge userGender:(NSString * _Nonnull)userGender;
+ (void)joinWithResponder:(UIResponder * _Nullable)responder userId:(NSString * _Nonnull)userId userValue:(NSInteger)userValue;
+ (void)deactivateWithResponder:(UIResponder * _Nullable)responder userId:(NSString * _Nonnull)userId;
@end


@interface AceTM (SWIFT_EXTENSION(AceTM))
+ (void)payWithPayName:(NSString * _Nullable)payName product:(AceProduct * _Nullable)product;
+ (void)payWithPayName:(NSString * _Nullable)payName products:(NSArray<AceProduct *> * _Nullable)products;
+ (void)buyNowWithProduct:(AceProduct * _Nullable)product;
+ (void)wishListWithProduct:(AceProduct * _Nullable)product;
+ (void)addCartWithProduct:(AceProduct * _Nullable)product;
+ (void)buyListWithPaymentMethod:(NSString * _Nullable)paymentMethod orderNumber:(NSString * _Nullable)orderNumber totalPrice:(id _Nullable)totalPrice product:(AceProduct * _Nullable)product;
+ (void)buyListWithPaymentMethod:(NSString * _Nullable)paymentMethod orderNumber:(NSString * _Nullable)orderNumber totalPrice:(id _Nullable)totalPrice products:(NSArray<AceProduct *> * _Nullable)products;
+ (void)detailViewWithResponder:(UIResponder * _Nullable)responder productNumber:(NSString * _Nullable)productNumber productName:(NSString * _Nullable)productName productPrice:(double)productPrice productCategory:(NSString * _Nullable)productCategory productImageUrl:(NSString * _Nullable)productImageUrl;
+ (void)detailViewWithPage:(NSString * _Nullable)page productNumber:(NSString * _Nullable)productNumber productName:(NSString * _Nullable)productName productPrice:(double)productPrice productCategory:(NSString * _Nullable)productCategory productImageUrl:(NSString * _Nullable)productImageUrl;
@end
